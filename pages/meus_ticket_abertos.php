...
$sql = "SELECT t.id, t.titulo, t.descricao, t.status, t.data_abertura, t.user_id, t.categoria , u.username 
        ...
        WHERE t.status = 'Aberto' AND t.user_id = ?";
$stmt = $conn->prepare($sql);
      ...
      <div class="card shadow col-md-12 mb-4">
        ...
        <div class="card-body">
          <div class="border-bottom pb-4 mb-4">
            ...
            <i class="fas fa-ticket-alt me-1"></i> Tickets Abertos
            </h3>
          </div>
                    ...
                    <div class="card shadow border-bottom-primary">
                        ...
                        <div class="card-footer bg-transparent border-top-0 d-flex justify-content-end">
                            <form action='' method='post' style='margin-right: 1rem;'>
                                ...
                                <button type='submit' name='submit_reply' class='btn btn-outline-success'><i class='fas fa-reply'></i> Chat</button>
                            </form>
                            <form action='../sys/process_close_ticket.php' method='post' >
                                <input type='hidden' name='ticket_id' value='<?php echo $row['id']; ?>'>
                                <button type='submit' name='submit_close' class='btn btn-outline-danger'><i class='fas fa-times'></i> Fechar</button>
                            </form>
                        </div>
